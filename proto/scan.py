...
"Modify"
from proto.database.core.dataset import Dataset
from proto.database.backends.db_iterator import DBIterator
from proto.exceptions import QuantumExhausted
from proto.types import QueryContext, Mappings, TriplePattern
from proto.preemptable_iterator import PreemptableIterator
from proto.utils_Iterator import EmptyIterator
from proto.iterators_pb2 import SavedScanIterator, SavedTriplePattern
from proto.utils import pyDict_to_protoDict
...
class ScanIterator(PreemptableIterator):
    ...
    """
    Add to satisfy this dependance
